...
#
# 侦查区域，进攻区域，占据区域
goal_subject_pair3 = {0: {'order_obs': [[{'subject': 'redall', 'place': 'g', 'goal': 'all'},
                                    {'subject': 'redall', 'place': 'l', 'goal': 'all'},
                                    {'subject': 'redall', 'place': 'm', 'goal': 'all'}]
                                   ]},
                      1: {'basic_support': [[{'place': 'm', 'goal': 'all'},
                                            {'place': 'g', 'goal': 'all'}]
                                            ],
                          'order_atk':[[{'place': 'l', 'goal': 'infantry'},
...
rules3 = {0:{},1:{}}
task.creat_LTL_formula_with_wave_picking(goal_subject_pair3, 'Global_attack', rules3)
