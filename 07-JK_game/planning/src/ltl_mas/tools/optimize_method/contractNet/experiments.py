...
case_2 = {  "subnet_num": 5,
            ...
            "subnet_1_agents": [ # 1号子网
                                ...
                                {"id": 3, "subnet_id": 1, "speed": 2.0, "initPos": [15.0,28.0], "value": 30, "attack": 50, "defense":30, "pref": 81},
            ...
            "subnet_3_agents": [ # 3号子网
                                ...
                                {"id": 12, "subnet_id": 3, "speed": 2.0, "initPos": [60.0,66.0], "value": 50, "attack": 53, "defense":28, "pref": 66}  ],
            "subnet_4_agents": [ # 4号子网
                                {"id": 13, "subnet_id": 4, "speed": 2.0, "initPos": [19.5,26.0], "value": 90, "attack": 95, "defense":55, "pref": 10},
                                {"id": 14, "subnet_id": 4, "speed": 2.0, "initPos": [65.0,58.5], "value": 71, "attack": 75, "defense":75, "pref": 30},
                                {"id": 15, "subnet_id": 4, "speed": 2.0, "initPos": [81.5,11.0], "value": 30, "attack": 48, "defense":27, "pref": 70},
                                {"id": 16, "subnet_id": 4, "speed": 2.0, "initPos": [31.5,46.0], "value": 42, "attack": 53, "defense":28, "pref": 46}  ],
            "subnet_5_agents": [ # 5号子网
                                {"id": 17, "subnet_id": 5, "speed": 2.0, "initPos": [22.5,56.0], "value": 55, "attack": 63, "defense":55, "pref": 40},
                                {"id": 18, "subnet_id": 5, "speed": 2.0, "initPos": [67.5,38.5], "value": 12, "attack": 20, "defense":45, "pref": 90},
                                {"id": 19, "subnet_id": 5, "speed": 2.0, "initPos": [9.0,43.0], "value": 18, "attack": 38, "defense":37, "pref": 70},
                                {"id": 20, "subnet_id": 5, "speed": 2.0, "initPos": [72.0,6.0], "value": 53, "attack": 53, "defense":28, "pref": 46}  ],
            ...
            "tasks": [ { "id": 1, "timeConsume": 35.0, "target": [80.0, 80.0], "value": 80, "threat": 70, "defense": 70, "priority": 10},
                       ...
                       { "id": 21, "timeConsume": 35.0, "target": [34.0, 8.0], "value": 80, "threat": 70, "defense": 70, "priority": 10},
                       { "id": 22, "timeConsume": 42.0, "target": [23.7, 18.0], "value": 95, "threat": 90, "defense": 80, "priority": 10},
                       { "id": 23, "timeConsume": 32.4, "target": [95.0, 52.5], "value": 75, "threat": 70, "defense": 35, "priority": 9},
                       { "id": 24, "timeConsume": 30.0, "target": [46.8, 45.1], "value": 70, "threat": 75, "defense": 40, "priority": 9},
                       { "id": 25, "timeConsume": 28.2, "target": [64.0, 1.6], "value": 68, "threat": 67, "defense": 25, "priority": 8},
                       { "id": 26, "timeConsume": 23.5, "target": [6.0, 45.2], "value": 60, "threat": 65, "defense": 30, "priority": 8},
                       { "id": 27, "timeConsume": 26.0, "target": [9.0, 92.5], "value": 62, "threat": 58, "defense": 34, "priority": 7},
                       { "id": 28, "timeConsume": 20.9, "target": [25.0, 87.7], "value": 59, "threat": 80, "defense": 45, "priority": 7}, 
                       { "id": 29, "timeConsume": 21.7, "target": [23.4, 18.0], "value": 53, "threat": 50, "defense": 20, "priority": 6}, 
                       { "id": 30, "timeConsume": 23.7, "target": [2.0, 38.6], "value": 53, "threat": 50, "defense": 20, "priority": 6},
                       { "id": 31, "timeConsume": 20.0, "target": [40.3, 54.0], "value": 80, "threat": 70, "defense": 70, "priority": 5},
                       { "id": 32, "timeConsume": 17.0, "target": [53.6, 98.0], "value": 95, "threat": 90, "defense": 80, "priority": 5},
                       { "id": 33, "timeConsume": 12.4, "target": [50.0, 32.5], "value": 75, "threat": 70, "defense": 35, "priority": 4},
                       { "id": 34, "timeConsume": 10.0, "target": [26.5, 30.1], "value": 70, "threat": 75, "defense": 40, "priority": 4},
                       { "id": 35, "timeConsume": 8.2, "target": [1.0, 13.6], "value": 68, "threat": 67, "defense": 25, "priority": 4} ]
            } 