# -*- coding: utf-8 -*-
from ltl_mas.visualization.LTL_plotter import ProdAut_Run
...
def dijkstra_plan_networkX(product, beta=10,Multy=None):
	...
	for prod_target in product.graph['accept']:
                ...
                if prod_target in product.predecessors(prod_target):
                        ...
                        loop[prod_target] = (product.edges[prod_target,prod_target]["weight"], [prod_target, prod_target])#here is correct
