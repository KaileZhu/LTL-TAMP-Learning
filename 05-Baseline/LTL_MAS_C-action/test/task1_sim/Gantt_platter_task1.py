...
def gantt_plotter(task_number,situation ):
	...
	plt.legend(loc=2, bbox_to_anchor=(0, 1.16),handles=patches,fontsize='25',ncol=5)
	#plt.legend(loc=2, bbox_to_anchor=(0, 1.16), fontsize=30, ncol=3)
	# XY轴标签
