...
# Bu_poset=Buchi_poset_builder(task31)#
...
end1=time.time()
#a.Begin_branch_search2(400,up_bound_method='greedy',low_bound_method='i+j',search_method='DFS')
#a.plot_bnb_graph_phi3()
...
solution=[[((0, 'tempp24', 'p24'), 'temp'),((5, 'scanp7', 'p7'), 'scan'),
 ...
 [((6, 'scanp1', 'p1'), 'scan'),
  ((14, 'scanp20', 'p20'), 'scan'),
  ((13, 'scant3', 't3'), 'scan')],
 [((9, 'tempp17', 'p17'), 'temp'),((4, 'scant6', 't6'), 'scan'),
  ((13, 'scant3', 't3'), 'scan'),
  ((15, 'scanp5', 'p5'), 'scan')],
 [],
 [((5, 'scanp7', 'p7'), 'scan'),
  ...
  ((4, 'scant6', 't6'), 'scan'),
  ((15, 'scanp5', 'p5'), 'scan')],
 [((3, 'washp7', 'p7'), 'wash_UAV'),((5, 'scanp7', 'p7'), 'scan'),
  ((6, 'scanp1', 'p1'), 'scan'),
  ((14, 'scanp20', 'p20'), 'scan'),
  ((4, 'scant6', 't6'), 'scan')],
 [((1, 'repairp1', 'p1'), 'repair_UGV_l'),((10, 'repairp5', 'p5'), 'repair_UGV_l')],
 [((2, 'fixt6', 't6'), 'fix_UGV_l'), ((12, 'washp20', 'p20'), 'wash_UGV_l')],
 [((3, 'washp7', 'p7'), 'wash_UGV_l'),((11, 'fixt3', 't3'), 'fix_UGV_l')],
 [((1, 'repairp1', 'p1'), 'repair_UGV_s'),((7, 'mowp7', 'p7'), 'mow'), ((10, 'repairp5', 'p5'), 'repair_UGV_s')],
              [((1, 'repairp1', 'p1'), 'repair_UGV_s'),((11, 'fixt3', 't3'), 'fix_UGV_s'),
               ((8, 'sweepp7', 'p7'), 'sweep'),
               ((16, 'mowp20', 'p20'), 'mow'),
               ((17, 'sweepp20', 'p20'), 'sweep')],
[((2, 'fixt6', 't6'), 'fix_UGV_s'), ((10, 'repairp5', 'p5'), 'repair_UGV_s')]]
...
[[0, 11.359577456930339, 201.35957745693034],
 [1, 1740.4552952291851, 2316.455295229185],
 [2, 203.49309369451385, 275.49309369451385],
 [3, 168.80832325451252, 733.8083232545125],
 [4, 847.833270474381, 883.833270474381],
 [5, 915.6995535962012, 1010.6995535962012],
 [6, 2316.455295229185, 2411.455295229185],
 [7, 2366.2329257473207, 2556.2329257473207],
 [8, 2556.2329257473207, 2746.2329257473207],
 [9, 26.53846265328872, 216.53846265328872],
 [10, 1129.5894810267318, 1705.5894810267318],
 [11, 66.50751837198558, 138.50751837198558],
 [12, 100.49875621120896, 665.498756211209],
 [13, 785.8390403453698, 821.8390403453698],
 [14, 665.498756211209, 760.498756211209],
 [15, 1705.5894810267318, 1800.5894810267318],
 [16, 665.498756211209, 855.498756211209],
 [17, 855.498756211209, 1045.498756211209]]

[[((13, 'scant3', 't3'), 'scan'), ((6, 'scanp1', 'p1'), 'scan')],
 [((14, 'scanp20', 'p20'), 'scan'),
  ((13, 'scant3', 't3'), 'scan'),
  ((4, 'scant6', 't6'), 'scan'),
  ((5, 'scanp7', 'p7'), 'scan'),
 ...
 [((12, 'washp20', 'p20'), 'wash_UAV'),
  ...
  ((5, 'scanp7', 'p7'), 'scan'),
  ((15, 'scanp5', 'p5'), 'scan')],
 [((2, 'fixt6', 't6'), 'fix_UGV_l'), ((1, 'repairp1', 'p1'), 'repair_UGV_l')],
 [((11, 'fixt3', 't3'), 'fix_UGV_l')],
 [((12, 'washp20', 'p20'), 'wash_UGV_l'),
...
new_solution=[[((5, 'scanp7', 'p7'), 'scan'),
 ...
 [((2, 'fixt6', 't6'), 'fix_UGV_l'), ((12, 'washp20', 'p20'), 'wash_UGV_l')],
 [((11, 'fixt3', 't3'), 'fix_UGV_l')],
 [((7, 'mowp7', 'p7'), 'mow'), ((10, 'repairp5', 'p5'), 'repair_UGV_s')],
              [((11, 'fixt3', 't3'), 'fix_UGV_s'),
               ((8, 'sweepp7', 'p7'), 'sweep'),
               ((16, 'mowp20', 'p20'), 'mow'),
               ((17, 'sweepp20', 'p20'), 'sweep')],
...
new_solution2=[[((0, 'tempp24', 'p24'), 'temp'),((5, 'scanp7', 'p7'), 'scan'),
  ((12, 'washp20', 'p20'), 'wash_UAV'),
  ((13, 'scant3', 't3'), 'scan'),
  ((15, 'scanp5', 'p5'), 'scan')],
 [((6, 'scanp1', 'p1'), 'scan'),
