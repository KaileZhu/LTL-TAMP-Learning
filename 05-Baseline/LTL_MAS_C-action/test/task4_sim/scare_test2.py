...
'&& <>(washp20_p20 && <> (mowp20_p20 && <> sweepp20_p20)&& <> scanp20_p20) && []((washp20_p20 || mowp20_p20) -> ! sweepp20_p20) ' \
    ...
    '&& <> tempt4_t4'
#\varphi 3
task3='<> (tempp25_p25 && <> repairp25_p25 && <>((scanp25_p25 && ! washp25_p25)&& <> (sweepp25_p25 && ! p26))) && <> tempt4_t4 &&' \
      '<>(sweepp8_p8 && <> washp8_p8) && <> repairp4_p4 && X ! p5 && <> (sweepp8_p8 && ! washp8_p8 && <> scanp8_p8) && ! tempt4_t4 U fixt4_t4'
...
# Bu_poset.main_fun_to_get_poset(500)
# print('the old state number is ',len(Bu_poset.buchi.nodes),'edges is',len(Bu_poset.buchi.edges))
# print(Bu_poset.poset_list[0],Bu_poset.poset_list[Bu_poset.language_list.index(min(Bu_poset.language_list))])
...
poset={'||': set(),
 '<=': {(0, 5),
  ...
  (9, 10)},
 '<': set(),
 '!=': {(0, 8), (1, 8), (2, 8), (3, 8), (4, 8), (6, 10)},
 '=': set(),
 'action_map': [(0, 'repairp4', 'p4'),
  (1, 'tempp25', 'p25'),
  (2, 'scanp25', 'p25'),
  (3, 'repairp25', 'p25'),
  (4, 'sweepp25', 'p25'),
