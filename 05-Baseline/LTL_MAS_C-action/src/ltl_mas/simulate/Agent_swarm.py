...
class Agent_swarm(object):
    ...
    def get_leader(self,task_list):
        leader_dic={}
        i=0
        for agent in task_list:
           for task in agent:
                print(task)
                if task[0][0] not in leader_dic.keys():
                    print(task[0][0],i)
                    leader_dic[task[0][0]]=i


           i=i+1
        self.current_leader_track[self.global_time]=leader_dic
    ...
    def begin_run(self,time_buget,time_step,online_update=0):
        ...
        #self.set_swarm_path()
        self.global_time=0
        self.current_leader_track={}
        self.get_leader(self.task_list)
        finish_task=set()
        todo_co_task_list=[]
        todo_co_task_list2=[]
        self.pose_track=[]
...
# threshold method
  ...
  []]
                ...
                new_node,time_table=self.begin_BnB_online_adaption(un_assign_task,agent_pose,
                                           ...
                                           ,1)
                s=1
                new_node=[[((2, 'scanp3', 'p3'), 'scan'), ((8, 'washp34', 'p34'), 'wash')],
  [((2, 'scanp3', 'p3'), 'scan')],
  [((8, 'washp34', 'p34'), 'wash'), ((9, 'scanp34', 'p34'), 'scan')],
  [],
  [((2, 'scanp3', 'p3'), 'scan'), ((9, 'scanp34', 'p34'), 'scan')],
