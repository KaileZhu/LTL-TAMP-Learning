# -*- coding: utf-8 -*-
from src.baseline.product_based.discrete_plan import dijkstra_plan_networkX, dijkstra_plan_optimal, improve_plan_given_history
...
class ltl_planner(object):
	...
	def optimal(self, beta=10, style='static'):
		...
		if style == 'static':
			...
			self.run, plantime ,self.prefix, self.suffix= dijkstra_plan_networkX(self.product, self.beta)
