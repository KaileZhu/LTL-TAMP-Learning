...
\begin{table}[t]
  ...
  \begin{tablenotes}\footnotesize
    \item[1] The number of different types of agents.
    \item[2] The associated solution time, when the
    first poset is returned and when the best poset with largest language is returned.
    \item[3] The associated solution time,
          when the first solution is returned,
          and when the optimal solution is returned.
  \end{tablenotes}
\end{threeparttable}
\end{table}
%==============================
