...
2025/2/2
测试MILP的
任务规模为6个子任务分给8个智能体时 → MILP大概需要用4min左右给出最优解
最优解的对应的任务分配方案，任务方案总时长和计算时长。
"""
...
if __name__ == '__main__':
    ...
    if opt_method == 'BnB':
        ...
        for index, (time_cost, finish_time) in run_MILP_time_cost.items():
            print('\n--------------------------------')
